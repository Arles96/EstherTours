...
const BranchOfficeTransportationEstablishment = new Mongo.Collection('BranchOfficeTransportationEstablishment');
...
const BranchOfficeTransportationEstablishmentSchema = new SimpleSchema({
...
BranchOfficeTransportationEstablishmentSchema.messageBox.messages(messages);

BranchOfficeTransportationEstablishment.helpers({
...
BranchOfficeTransportationEstablishment.attachSchema(BranchOfficeTransportationEstablishmentSchema);

export {
  BranchOfficeTransportationEstablishment,
